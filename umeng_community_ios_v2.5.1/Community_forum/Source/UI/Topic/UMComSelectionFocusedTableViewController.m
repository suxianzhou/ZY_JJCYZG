//
//  UMComSelectionFocusedTableViewController.m
//  UMCommunity
//
...
@interface UMComSelectionFocusedTableViewController ()

@end

@implementation UMComSelectionFocusedTableViewController

- (void)viewDidLoad {
    self.fetchRequest = [[UMComUserTopicsRequest alloc]initWithUid:[UMComSession sharedInstance].loginUser.uid count:BatchSize];
    [super viewDidLoad];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *seletionCellReuseIdentifier = @"SelectionFocusedTableView_TopicTypeCellID";
