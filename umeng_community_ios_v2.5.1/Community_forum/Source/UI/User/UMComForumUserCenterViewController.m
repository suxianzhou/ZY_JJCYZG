...
@interface UMComForumUserCenterViewController ()<UMComUserProfileDetaiViewDelegate, UMComUserOperationFinishDelegate, UIActionSheetDelegate, UMComScrollViewDelegate>
...
- (void)creatChildViewControllers
{
    ...
    postTableViewController.showEditButton = NO;
