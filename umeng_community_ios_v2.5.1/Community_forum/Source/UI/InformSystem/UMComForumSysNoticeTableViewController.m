...
#define UMCom_Forum_SysNotice_Date_TextFont 10
#define UMCom_Forum_SysNotice_Date_TextColor @"#A5A5A5"
#define UMCom_Forum_SysNotice_Date_Width    100
#define UMCom_Forum_SysNotice_Content_TextFont 13
...
{
    UIEdgeInsets edge = UIEdgeInsetsMake(tableView.rowHeight - 0.5, 60, 0, 0);
