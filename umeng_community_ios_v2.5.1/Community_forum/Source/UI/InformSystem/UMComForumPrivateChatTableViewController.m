...
NSString *const kUMComForumMutitext = @"mutitext";
NSString *const kUMComForumPrivateMessage = @"privateMessage";
...
{
    UMComMutiText *mutiText = [self.chatDataArray[indexPath.row] valueForKey:kUMComForumMutitext];
...
{
    UMComPrivateMessage *privateMessage = [self.chatDataArray[indexPath.row] valueForKey:kUMComForumPrivateMessage];
...
- (void)insertCellWithPrivateMessage:(UMComPrivateMessage *)privateMessage isMore:(BOOL)isMore
{
    ...
    [dataDict setValue:privateMessage forKey:kUMComForumPrivateMessage];
    [dataDict setValue:mutiText forKey:kUMComForumMutitext];
    CGFloat index = 0;
    if (!isMore) {
