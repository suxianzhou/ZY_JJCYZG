...
#define UMCom_Forum_InfoCenter_Icon_LeftEdge 10
...
- (void)viewDidLoad {
    ...
    self.titles = [NSArray arrayWithObjects:UMComLocalizedString(@"um_com_comment", @"评论"),UMComLocalizedString(@"um_com_favour",@"赞"),UMComLocalizedString(@"um_com_notification", @"通知"),UMComLocalizedString(@"um_com_managerPrivateMessage", @"管理员私信"), nil];
...
//{
//    UIEdgeInsets edge = UIEdgeInsetsMake(tableView.rowHeight - 0.5, 60, 0, -60);
